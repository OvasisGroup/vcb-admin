...
import { TransactionLogs, columns } from "./columns"
...
async function getData(): Promise<TransactionLogs[]> {
    ...
    const res = await fetch(`${process.env.NEXTAUTH_URL_API}/account/logs/transactions`, {
        method: 'GET',
        headers: {
    ...
    return (
        <div className='p-6 mt-4'>
            <div className="flex justify-between items-center mb-4 bg-slate-300 p-4 rounded-2xl">
                <div><p className="font-light text-2xl  text-vcblue">Transaction Logs</p>
                    <p className="font-light text-black">monitoring/transaction-logs</p>
                </div>
            </div>
