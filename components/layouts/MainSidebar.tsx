      ...
      <ul className="mt-4">
        <Link href="/dashboard">
          ...
          <Dropdown
            ...
            title="Dashboard"
            items={[{ icon: "", label: "", link: "/dashboard" }]}
          />
        </Link>
        <Dropdown
          ...
          items={[
            { icon: "", label: "Roles", link: "/dashboard/maintenance/roles" },
            {
              icon: "",
              label: "Approve Roles",
              link: "/dashboard/maintenance/approve-roles",
            },
            {
              icon: "",
              label: "Bank Admin",
              link: "/dashboard/maintenance/bank-admin",
            },
            {
              icon: "",
              label: "Approve Bank Admin",
              link: "/dashboard/maintenance/approve-bank-admin",
            },
            {
              icon: "",
              label: "Security Parameters",
              link: "/dashboard/maintenance/security-parameters",
            },
          ]}
        />
        <Dropdown
          ...
          items={[
            {
              icon: "",
              label: "Roles",
              link: "/dashboard/corporate-maintenance/roles",
            },
            {
              icon: "",
              label: "Approve Roles",
              link: "/dashboard/corporate-maintenance/approve-roles",
            },
            {
              icon: "",
              label: "Corporate Admin",
              link: "/dashboard/corporate-maintenance/corporate-admin",
            },
            {
              icon: "",
              label: "Approve Corporate Admin",
              link: "/dashboard/corporate-maintenance/approve-corp-admin",
            },
            {
              icon: "",
              label: "Corporate Registration",
              link: "/dashboard/corporate-maintenance/corporate-registration",
            },
            {
              icon: "",
            ...
            },
            {
              ...
              link: "/dashboard/corporate-maintenance/user-registration",
            },
            {
              icon: "",
              label: "Approve User",
              link: "/dashboard/corporate-maintenance/approve-user",
            },
            {
              icon: "",
              label: "Create Workgroup",
              link: "/dashboard/corporate-maintenance/create-workgroup",
            },
            {
              icon: "",
              label: "Map Workgroup",
              link: "/dashboard/corporate-maintenance/map-workgroup",
            },
          ]}
        />
        <Dropdown
          ...
          items={[
            {
              icon: "",
              label: "CIF Mapping",
              link: "/manage_corp_user/cif-mapping",
            },
            {
              icon: "",
              label: "CIF Account Mapping",
              link: "/manage_corp_user/cif-account-mapping",
            },
            {
              icon: "",
              label: "Delink Account",
              link: "/manage_corp_user/delink-account",
            },
            {
              icon: "",
              label: "Delink CIF",
              link: "manage_corp_user/delink-cif",
            },
          ]}
        />
        <Dropdown
          ...
          items={[
            { icon: "", label: "App Usage", link: "reports/app-usage" },
            {
              ...
              link: "/reports/transactions-volumes",
            },
            {
              icon: "",
              label: "User Activity",
            ...
            },
            {
              ...
              link: "/reports/active-inactive-users",
            },
          ]}
        />
        <Dropdown
        ...
        <Dropdown
          ...
          items={[
            { icon: "", label: "GLS", link: "/parameters/gls" },
            {
              ...
              link: "/parameters/exchange-rates",
            },
          ...
          items={[
            {
              ...
              link: "/dashboard/monitoring/transaction-logs",
            },
            {
              icon: "",
              label: "User Activity",
              link: "/monitoring/user-activity",
            },
